...
| Lacunas DEV-0001..DEV-0044 | Gates especificos | Resolver por precedencia e testes antes de declarar gate afetado |
...
| FR-006 depende de RBAC ainda nao implementado | Declarar gestao de usuarios segura | Manter pendente na PHASE-006 e concluir com `users.manage` deny-by-default na PHASE-007, conforme DEV-0032 |
...
| OpenAPI automatica depende da fundacao transversal | Declarar contrato gerado a partir dos schemas | Contrato 3.1 estatico esta testado; substituir pela geracao automatica na PHASE-008, conforme DEV-0039 |
