...
| FR-023 | IMPLEMENTED | `ClientsService.list`, `ClientsPage` | API-010 | DB-020 + indices | `clients.read` ALL/OWN | Busca/filtros/cursor/SQLi | PHASE-010 | GATE-010 | Nome, nome fantasia, documento, e-mail, status e tags com cursor estavel aprovados |
